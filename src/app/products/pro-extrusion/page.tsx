...
export default function Page() {
  const product = products.find((p) => p.slug === "pro-extrusion")
  return (
          ...
          <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
            <div className="border-t border-gray-200 pt-4">
              ...
              <dd className="mt-2 text-sm text-gray-500">
                Precious Plastic Extruder Pro (Ext-30)
              </dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <dd className="mt-2 text-sm text-gray-500">4 kW</dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
              <dt className="font-medium text-gray-900">
                Barrel Outside Diameter
              </dt>
              <dd className="mt-2 text-sm text-gray-500">60 mm</dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
              <dt className="font-medium text-gray-900">Heat Power Input</dt>
              <dd className="mt-2 text-sm text-gray-500">2.1 kW</dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
              <dt className="font-medium text-gray-900">Comp Screw Eff Len</dt>
              <dd className="mt-2 text-sm text-gray-500">600 mm</dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
              <dt className="font-medium text-gray-900">Max RPM</dt>
              <dd className="mt-2 text-sm text-gray-500">120 rpm</dd>
            </div>
            <div className="border-t border-gray-200 pt-4">
